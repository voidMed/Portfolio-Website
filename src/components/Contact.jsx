      ...
      <div className="contact-content">
        ...
        <div className="contact-info">
          <div className="contact-item">
            ...
            <span>m.azeroual1204@gmail.com</span>
          </div>
          <div className="contact-item">
          ...
          <div className="contact-socials">
            <a href="https://github.com/voidMed" aria-label="GitHub" target="_blank" rel="noreferrer">
            ...
            <a href="https://www.linkedin.com/in/mohamed-azeroual-a8371024b" aria-label="LinkedIn" target="_blank" rel="noreferrer">
